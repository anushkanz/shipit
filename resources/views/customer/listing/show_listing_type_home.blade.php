    ...
    <div class="border-b border-gray-900/10 pb-12">
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    @php
                        if(!empty($return_array['collection_meta_level'])){
                            if($return_array['collection_meta_level'] == 0){
                                ...
                                echo '<p>Level '.$return_array['collection_meta_level'].'</p>';
                            }else{
                ...
                <div class="mt-2">
                    @php
                        if(!empty($return_array['collection_meta_help'])){
                            if($return_array['collection_meta_help'] == 1){
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    @php
                        if(!empty($return_array['collection_meta_delivery_level'])){
                            if($return_array['collection_meta_delivery_level'] == 0){
                                ...
                                echo '<p>Level '.$return_array['collection_meta_delivery_level'].'</p>';
                            }else{
                                echo '<p>Level 11 or above</p>';
                            }
                        }
